...
@UseTestDataFrom("src/test/resources/features/search/LoginDataInvalid.csv")
public class LoginInvalidTest {
    ...
    @Test
    public void log_in_tests_for_invalid_password(){
        loginSteps.is_the_home_page();
        loginSteps.logs_in(username, password);
        loginSteps.should_see_error_message(description);
    }
}
